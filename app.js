    ...
    render() {
        return (
            <div className="container">
                ...
                <div className="container border rounded my-3 p-2 section-what">
                    <span className="h3">
                        What's that?
                    </span>
                ...
                <div className="container border rounded my-3 p-2 section-penis">
                    <span className="h3">
                        PENIS.
                    </span>
                    <div className="section-content">
                ...
                <div className="container border rounded my-3 p-2 section-help">
                    <span className="h3">
